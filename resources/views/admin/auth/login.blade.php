...
<body class="bg-slate-50 text-slate-900 min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 class="mt-6 text-center text-2xl font-bold tracking-tight text-slate-900">
            Login Partner & Panitia
        </h2>
        <p class="mt-2 text-center text-sm text-slate-500">
            Masuk ke dashboard kepanitiaan dan manajemen event Anda
        </p>
    </div>
        ...
        <div class="bg-white py-8 px-6 shadow-sm border border-slate-200/80 rounded-2xl sm:px-10">
            ...
            <form class="space-y-5" action="{{ route('admin.login.post') }}" method="POST">
                ...
                <div>
                    ...
                    <div class="mt-1.5">
                        <input id="email" name="email" type="email" autocomplete="email" required placeholder="admin@amikom.ac.id" value="{{ old('email') }}"
